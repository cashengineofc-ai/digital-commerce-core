...
export const Route = createFileRoute("/convite/$code")({
  component: AffiliateInvitePage,
});

function AffiliateInvitePage() {
    ...
    async function load() {
      ...
      try {
        ...
        const [{ data, error: rpcError }, auth] = await Promise.all([
          (supabase as any).rpc("fn_afiliado_convite_visualizar", {
            p_code: code,
            p_token: token,
          }),
        ...
        setPreview({
          ...
          commission:
            data?.commission == null ? null : Number(data.commission),
      ...
      <section className="w-full max-w-lg rounded-2xl border border-border bg-card p-6 shadow-sm">
        {loading ? (
          ...
          <div className="py-8 text-center">
            ...
            <h1 className="mt-4 text-xl font-semibold">Convite aceito</h1>
            <p className="mt-2 text-sm text-muted-foreground">
              Seu vínculo foi criado como pendente. A empresa ainda precisa aprovar a afiliação antes de você divulgar produtos.
            </p>
            <Link
              to="/app"
          ...
          <>
            <div className="flex items-start gap-3">
              ...
              <div>
                <h1 className="text-xl font-semibold">Convite para afiliação</h1>
              ...
              <div className="flex justify-between gap-4">
                ...
                <span className="font-medium">
                  {preview.commission == null
                    ...
                    : formatPct(preview.commission, 2)}
                </span>
              </div>
              <div className="flex justify-between gap-4">
            ...
            <p className="mt-4 text-xs text-muted-foreground">
              O convite só pode ser aceito pela conta cujo e-mail corresponde ao destinatário e apenas uma vez.
            </p>
          </>
        ) : null}
      </section>
